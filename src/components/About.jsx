...
const About = () => {
  return (
    <div className={style.contenedor}>
      ...
      <a className={style.boton} href='https://drive.google.com/file/d/1bvhggXv_9rjPF7O9-5eltfdw19nll56s/view?usp=sharing' target="_blank" rel="noopener noreferrer">ver CV🚀</a>
       </div>
       </Fade>
      </div>
